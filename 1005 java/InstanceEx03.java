...
//	public int getProductYear() {						// 자동으로 생성된 멤버 메소드
//		return productYear;
//	}
...
public class InstanceEx03 {		// 파일명과 이름이 같은 클래스에만 public 붙임
	...
	public static void main(String[] args) {
		...
		new Robot().setProductYear(2032);	// 객체 생성은 되지만 주소를 불러올 지역 변수가 없어 사용 불가능.
											// Garbage Collector에 의해 자동으로 삭제됨.
		
		Robot r3 = r2;		// r3라는 참조 변수 생성 (객체 생성은 안 했음). 근데 r3 = r2
