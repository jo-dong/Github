...
open boolean,
regions varchar(100),
itemtype varchar(10) check(itemtype in ('BEAUTY', 'BOOK', 'FASHION', 'FOOD', 'ETC')),
...
public class Item {
	...
	@CollectionTable(name = "regions", joinColumns = @JoinColumn(name = "item_id"))
	@Column(name = "regions")
	private List<String> regions = new ArrayList<String>();	// 지역
